(function (global, factory) {
    ...
    (global = global || self, factory(global['ngx-chess-board'] = {}, global.ng.cdk['drag-drop'], global.ng.common, global.ng.core, global.rxjs, global.lodash));
}(this, (function (exports, dragDrop, common, core, rxjs, lodash) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NgxChessBoardComponent = /** @class */ (function () {
        function NgxChessBoardComponent(ngxChessBoardService) {
            ...
            this.moveChange = new core.EventEmitter();
            this.checkmate = new core.EventEmitter();
            this.stalemate = new core.EventEmitter();
            this.selected = false;
        ...
        NgxChessBoardComponent.propDecorators = {
            darkTileColor: [{ type: core.Input }],
            lightTileColor: [{ type: core.Input }],
            showCoords: [{ type: core.Input }],
            dragDisabled: [{ type: core.Input }],
            drawDisabled: [{ type: core.Input }],
            lightDisabled: [{ type: core.Input }],
            darkDisabled: [{ type: core.Input }],
            moveChange: [{ type: core.Output }],
            checkmate: [{ type: core.Output }],
            stalemate: [{ type: core.Output }],
            boardRef: [{ type: core.ViewChild, args: ['boardRef', { static: false },] }],
            modal: [{ type: core.ViewChild, args: ['modal', { static: false },] }],
            size: [{ type: core.Input, args: ['size',] }],
            pieceIcons: [{ type: core.Input, args: ['pieceIcons',] }],
